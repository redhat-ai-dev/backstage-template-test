...
import { TestFileMatchesTemplate, RenderTemplates } from '..';
...
describe('catalog model template tests', () => {
    ...
    test('001-model-required-values-only', () => {
        ...
        testModelCatalogDefaults(path.join("test", "test_data", "model", "001-required-values-only"), modelTemplateValues);
    });
    ...
    test('002-model-all-techdocs', () => {
        ...
        testModelCatalogDefaults(path.join("test", "test_data", "model", "002-model-all-techdocs"), modelTemplateValues);
        testModelCatalogTechdocs(path.join("test", "test_data", "model", "002-model-all-techdocs"), modelTemplateValues);
    });
});
...
describe('catalog model server template tests', () => {
    ...
    test('001-model-server-defaults-no-api', () => {
        ...
        testModelServerCatalogDefaults(path.join("test", "test_data", "model-server", "001-model-server-defaults-no-api"), modelServerTemplateValues);
    });
    ...
    test('002-model-server-defaults-all', () => {
        ...
        testModelServerCatalogDefaults(path.join("test", "test_data", "model-server", "002-model-server-defaults-all"), modelServerTemplateValues);
    });
});
...
function testModelCatalogDefaults(testFolderPath: string, values: object) {
    ...
    let modelTemplatePath = path.join("test", "template", "model");
...
function testModelServerCatalogDefaults(testFolderPath: string, values: object) {
    let catalogInfopath = path.join(testFolderPath, catalogInfoName);
    let modelServerTemplatePath = path.join("test", "template", "model-server");
